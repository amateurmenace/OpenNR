...
// Speak — the film-emulation counterpart (org.opennr.Speak) — began here as a
// second plugin in this bundle and moved to its own repo + bundle at v0.2:
// github.com/amateurmenace/Speak. Hush hands it the clean-confidence matte via
// "Export Clean Matte to Alpha" (v3.7).
